$(document).ready(function(){
    ...
    var table = $('#datatable').DataTable({
        ...
        "columns": [
            ...
            {"data": "visit_percent", "name": "visit_percent", "orderable": true},
            ...
            {"data": "first_visit_price", "name": "first_visit_price", "orderable": true},
        ]
    });
    ...
    var date = $('#date').datetimepicker({
        ...
        var stringdate = event.date.format('YYYY/MM');
    ...
    var last_date = $('#last_date').datetimepicker({
        ...
        table.column(3).search(event.date.format('YYYY/MM')).draw();
    });
});