                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url($link) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- 姓名 -->
                            <label class="control-label col-md-3 col-sm-3" for="title">姓名 * :</label>
                            <div class="col-md-8 col-sm-8">
                                <input class="form-control" type="text" name="title" value="{{ old('title') }}" placeholder="姓名" data-parsley-required="true" id="title" />
                            </div>
                        </div>
                        <div class="form-group"><!-- 性别 -->
                            <label class="control-label col-md-3 col-sm-3" for="gender">性别 * :</label>
                            <div class="col-md-8 col-sm-8">
                        ...
                        <div class="form-group"><!-- 出生日期 -->
                            <label class="control-label col-md-3 col-sm-3" for="birthday">出生日期 * :</label>
                            <div class="col-md-8 col-sm-8">
                                <input class="form-control" type="text" name="birthday" value="{{ old('birthday') }}" placeholder="出生日期" data-parsley-required="true" id="birthday" />
                            </div>
                        </div>
