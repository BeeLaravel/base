                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url($link.'/'.$item['id']) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- 性别 -->
                            ...
                            <div class="col-md-8 col-sm-8">
                                <select class="form-control" name="gender">
                                    <option value="unknow" @if ( $item['gender']=='unknow' ) selected @endif>unknow</option>
                        ...
                        <div class="form-group"><!-- 出生日期 -->
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input class="form-control" type="text" name="birthday" value="{{ $item['birthday'] }}" placeholder="出生日期" data-parsley-required="true" id="birthday" />
                            </div>
                        </div>
