            ...
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url('/admin/pages/'.$item['id']) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- 发布时间 -->
                            <label class="control-label col-md-3 col-sm-3" for="published_at">发布时间 * :</label>
                            <div class="col-md-8 col-sm-8">
                                <input class="form-control" type="text" name="published_at" value="{{ $item['published_at'] }}" placeholder="发布时间" data-parsley-required="true" id="published_at" />
                            </div>
                        </div>
