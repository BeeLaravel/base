                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url($link) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- 歌手 -->
                            ...
                            <div class="col-md-8 col-sm-8">
                                <ul id="singers" class="success"></ul>
                            </div>
                        </div>
                        <div class="form-group"><!-- 韵文 -->
                            <label class="control-label col-md-3 col-sm-3" for="poem">韵文 :</label>
                            <div class="col-md-8 col-sm-8">
                                <textarea class="form-control" name="poem" placeholder="韵文" id="poem">{{old('poem')}}</textarea>
                            </div>
                        </div>
                        <div class="form-group"><!-- 歌词 -->
                            <label class="control-label col-md-3 col-sm-3" for="lyric">歌词 :</label>
                            <div class="col-md-8 col-sm-8">
                                <textarea class="form-control" name="lyric" placeholder="歌词" id="lyric">{{old('lyric')}}</textarea>
                            </div>
                        </div>
