                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url($link.'/'.$item['id']) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- 韵文 -->
                            ...
                            <div class="col-md-8 col-sm-8">
                                <textarea class="form-control" name="poem" placeholder="韵文" id="poem">{{ $item['poem'] }}</textarea>
                            </div>
                        </div>
                        <div class="form-group"><!-- 歌词 -->
                            <label class="control-label col-md-3 col-sm-3" for="lyric">歌词 :</label>
                            <div class="col-md-8 col-sm-8">
                                <textarea class="form-control" name="lyric" placeholder="歌词" id="lyric">{{ $item['lyric'] }}</textarea>
                            </div>
                        </div>
