        ...
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered parsley" action="{{ url($link) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                @foreach ( $permissions as $key => $value )
                                    <div class="col-md-3 col-sm-3 permission">
                                        <input type="checkbox" class="parent" name="permissions[]" data-render="switchery" data-theme="purple" value="{{ $value['id'] }}"/> <span style="font-weight: bolder;">{{ $value['title'] }}</span>
                                    </div>
                                    @if ( $value['children'] )
                                        <div class="col-md-9 col-sm-9 sub-permissions">
                                            @foreach ( $value['children'] as $k => $v )
                                                <div class="col-md-4 col-sm-4 permission">
                                                    <input type="checkbox" name="permissions[]" data-render="switchery" data-theme="purple" value="{{ $v['id'] }}"/> <span>{{ $v['title'] }}</span>
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
