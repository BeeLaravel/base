                    ...
                    <table class="table table-bordered table-hover responsive dt-responsive" id="datatable" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" style="min-width: 30px;">在班<br>人数</th>
                                <th colspan="2">总回访量</th>
                                <th colspan="2">有效回访量</th>
                                <th colspan="2">老数据总回访量</th>
                                <th colspan="2">老数据有效回访量</th>
                                <th rowspan="2" style="min-width: 30px;">到诊</th>
                                <th rowspan="2" style="min-width: 30px;">到诊<br>金额</th>
                                <th rowspan="2" style="min-width: 30px;">预到诊</th>
                            </tr>
                            <tr>
                                <th style="min-width: 30px;">总回<br>访量</th>
                                <th style="min-width: 30px;">人均</th>
                                <th style="min-width: 45px;">有效<br>回访量</th>
                                <th style="min-width: 30px;">人均</th>
                                <th style="min-width: 30px;">总回<br>访量</th>
                                <th style="min-width: 30px;">占比</th>
                                <th style="min-width: 45px;">有效<br>回访量</th>
                                <th style="min-width: 30px; border-right: 1px solid;">占比</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{asset('statics/admin/scripts/report/contact.js')}}"></script>
