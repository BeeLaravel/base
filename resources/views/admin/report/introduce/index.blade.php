                    ...
                    <table class="table table-bordered table-hover responsive dt-responsive" id="datatable" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" style="min-width: 30px;">预约</th>
                                <th colspan="2">到诊</th>
                                <th colspan="3">业绩</th>
                                <th rowspan="2" style="min-width: 30px;">初诊客单价</th>
                            </tr>
                            <tr>
                                <th style="min-width: 30px;">到诊</th>
                                <th style="min-width: 30px;">到诊<br>率</th>
                                <th style="min-width: 30px;">初诊<br>业绩</th>
                                <th style="min-width: 30px;">复诊<br>业绩</th>
                                <th style="min-width: 30px; border-right: 1px solid;">总<br>业绩</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{asset('statics/admin/scripts/report/introduce.js')}}"></script>
