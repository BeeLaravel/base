                    ...
                    <table class="table table-bordered table-hover responsive dt-responsive" id="datatable" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" style="min-width: 42px;">渠道</th>
                                <th colspan="2">费用</th>
                                <th colspan="2">对话</th>
                                <th colspan="2">预约</th>
                                <th colspan="2">到诊</th>
                                <th colspan="3">业绩</th>
                                <!-- <th rowspan="2" style="min-width: 30px;">无效<br>对话</th> -->
                                <!-- <th rowspan="2" style="min-width: 45px;">无效对<br>话占比</th> -->
                            </tr>
                            <tr>
                                ...
                                <th style="min-width: 30px;">预约数</th>
                                <th style="min-width: 30px;">预约<br>成本</th>
                                <th style="min-width: 30px;">到诊数</th>
                                <th style="min-width: 30px;">到诊<br>成本</th>
                                <th style="min-width: 30px;">总<br>业绩</th>
                                <th style="min-width: 30px;">初诊<br>业绩</th>
                                <th style="min-width: 30px;">复诊<br>业绩</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{asset('statics/admin/scripts/report/platform.js')}}"></script>
