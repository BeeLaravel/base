                            ...
                            <div class="col-md-8 col-sm-8">
                                <div id="editor" class="editor">
                                    @if ( $item['content_type']=='ueditor' )
                                        <script type="text/plain" name="content" id="myEditor">{!! $item['content']['content'] !!}</script>
                                    @else
                                        <textarea name="content" class="form-control" id='myEditor'>{{ $item['content']['content'] }}</textarea>
                                    @endif
                                </div>
                            </div>
                        </div>
