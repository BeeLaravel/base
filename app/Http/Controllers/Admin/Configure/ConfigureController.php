...
use App\Models\Configure\Configure as ThisModel;

use Illuminate\Http\Request;
use App\Http\Requests\Configure\ConfigureRequest as ThisRequest;
...
class ConfigureController extends Controller {
    private $baseInfo = [
        ...
        'view_path' => 'admin.configure.configure.',
        'api_list' => 'configure',
    ];
    private $show = [
        'id',
        ...
        if ( $request->ajax() ) {
            ...
            if ( $model ) {
                foreach ( $model as $item ) {
                    $item->slug = "<a href='".url($this->baseInfo['link'].'/'.$item->id)."'>".$item->slug."</a>";
